...
export  INIT_TIMEOUT_bReadCompareValue
export _INIT_TIMEOUT_bReadCompareValue
export  INIT_TIMEOUT_bReadTimer
export _INIT_TIMEOUT_bReadTimer
export  INIT_TIMEOUT_bReadTimerSaveCV
export _INIT_TIMEOUT_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bINIT_TIMEOUT_ReadCompareValue  ; deprecated
export _bINIT_TIMEOUT_ReadCompareValue  ; deprecated
export  bINIT_TIMEOUT_ReadTimer         ; deprecated
export _bINIT_TIMEOUT_ReadTimer         ; deprecated
export  bINIT_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _bINIT_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  bINIT_TIMEOUT_ReadCounter       ; obsolete
export _bINIT_TIMEOUT_ReadCounter       ; obsolete
export  bINIT_TIMEOUT_CaptureCounter    ; obsolete
export _bINIT_TIMEOUT_CaptureCounter    ; obsolete
...
_INIT_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[INIT_TIMEOUT_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_INIT_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[INIT_TIMEOUT_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: INIT_TIMEOUT_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 INIT_TIMEOUT_bReadCompareValue:
_INIT_TIMEOUT_bReadCompareValue:
 bINIT_TIMEOUT_ReadCompareValue:                 ; this name deprecated
_bINIT_TIMEOUT_ReadCompareValue:                 ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[INIT_TIMEOUT_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: INIT_TIMEOUT_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 INIT_TIMEOUT_bReadTimerSaveCV:
_INIT_TIMEOUT_bReadTimerSaveCV:
 bINIT_TIMEOUT_ReadTimerSaveCV:                  ; this name deprecated
_bINIT_TIMEOUT_ReadTimerSaveCV:                  ; this name deprecated
 bINIT_TIMEOUT_ReadCounter:                      ; this name deprecated
_bINIT_TIMEOUT_ReadCounter:                      ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[INIT_TIMEOUT_CONTROL_REG]        ; save the Control register
   push  A
   mov   A, reg[INIT_TIMEOUT_COMPARE_REG]        ; save the Compare register
   push  A
   mov   A, reg[INIT_TIMEOUT_COUNTER_REG]        ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[INIT_TIMEOUT_COMPARE_REG]        ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: INIT_TIMEOUT_bReadTimer
;
;  DESCRIPTION:
...
;
 INIT_TIMEOUT_bReadTimer:
_INIT_TIMEOUT_bReadTimer:
 bINIT_TIMEOUT_ReadTimer:                        ; this name deprecated
_bINIT_TIMEOUT_ReadTimer:                        ; this name deprecated
 bINIT_TIMEOUT_CaptureCounter:                   ; this name deprecated
_bINIT_TIMEOUT_CaptureCounter:                   ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[INIT_TIMEOUT_COUNTER_REG]        ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[INIT_TIMEOUT_COMPARE_REG]        ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

...
//-------------------------------------------------
#pragma ioport  TX8_2_CONTROL_REG:  0x02b                  // Control register
BYTE            TX8_2_CONTROL_REG;
#pragma ioport  TX8_2_TX_SHIFT_REG: 0x028                  // TX Shift Register register
BYTE            TX8_2_TX_SHIFT_REG;
#pragma ioport  TX8_2_TX_BUFFER_REG:    0x029              // TX Buffer Register
BYTE            TX8_2_TX_BUFFER_REG;
#pragma ioport  TX8_2_FUNC_REG: 0x128                      // Function register
BYTE            TX8_2_FUNC_REG;
#pragma ioport  TX8_2_INPUT_REG:    0x129                  // Input register
BYTE            TX8_2_INPUT_REG;
#pragma ioport  TX8_2_OUTPUT_REG:   0x12a                  // Output register

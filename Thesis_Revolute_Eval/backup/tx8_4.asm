...
;  Global Symbols
;-----------------------------------------------
export   TX8_4_SetTxIntMode
export  _TX8_4_SetTxIntMode
export   TX8_4_EnableInt
export  _TX8_4_EnableInt
export   TX8_4_DisableInt
export  _TX8_4_DisableInt
export   TX8_4_Start
export  _TX8_4_Start
export   TX8_4_Stop
export  _TX8_4_Stop
export   TX8_4_SendData
export  _TX8_4_SendData
export   TX8_4_bReadTxStatus
export  _TX8_4_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX8_4_ReadTxStatus
export  _bTX8_4_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX8_4_PutSHexByte
export _TX8_4_PutSHexByte
export  TX8_4_PutSHexInt
export _TX8_4_PutSHexInt

export  TX8_4_CPutString
export _TX8_4_CPutString
export  TX8_4_PutString
export _TX8_4_PutString
export  TX8_4_PutChar
export _TX8_4_PutChar
export  TX8_4_Write
export _TX8_4_Write
export  TX8_4_CWrite
export _TX8_4_CWrite
export  TX8_4_PutCRLF
export _TX8_4_PutCRLF 
...
_TX8_4_EnableInt:
   ...
   M8C_EnableIntMask  TX8_4_INT_REG, TX8_4_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_DisableInt
;
;  DESCRIPTION:
...
_TX8_4_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX8_4_INT_REG, TX8_4_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
_TX8_4_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX8_4_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX8_4_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX8_4_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX8_4_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX8_4_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_bReadTxStatus
;
;  DESCRIPTION:
...
;
 TX8_4_bReadTxStatus:
_TX8_4_bReadTxStatus:
 bTX8_4_ReadTxStatus:
_bTX8_4_ReadTxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[TX8_4_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_PutSHexByte
;
;  DESCRIPTION:
...
_TX8_4_PutSHexByte:
    ...
    index TX8_4_HEX_STR                ; Get Hex value
    call  TX8_4_PutChar                ; Write data to screen
    pop   A                            ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_PutSHexInt
;
;  DESCRIPTION:
...
_TX8_4_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX8_4_PutSHexByte            ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX8_4_PutSHexByte            ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[TX8_4_CONTROL_REG], TX8_4_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX8_4_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm
...
.PutStringLoop:
   ...
   call  TX8_4_PutChar                      ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_4_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;
...
_TX8_4_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX8_4_PutChar                      ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX8_4_CPutString                        ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   TX8_4_CPutString
